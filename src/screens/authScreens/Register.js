...
const incorrectPasswordText =
  'The password you entered is incorrect. Please make sure you enter the correct password. If you forgot it you may reset it by clicking FORGOT PASSWORD';
...
export default function Register({navigation, route, props}) {
  ...
  async function sendDataToServer() {
    ...
    await axios
      .post(`${Util.getApiStartPoint()}/Auth/Register`, data)
      .then((request) => {
