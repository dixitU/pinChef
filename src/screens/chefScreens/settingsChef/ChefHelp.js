        ...
        <ScrollView style={{flex: 1, backgroundColor: '#fFF', paddingTop: 15}}>
          <View style={styles.itemContainer}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('Chef_Settings_Faqs')}>
          ...
          <View style={styles.itemContainer}>
            <TouchableOpacity
              style={{width: '100%', height: '100%'}}
              onPress={() => navigation.navigate('Chef_Settings_TermsPolicy')}>
              <View style={styles.item}>
                <View style={styles.LeftIconContainer}>
                  <TermsAndPolicy />
          ...
          <View style={styles.itemContainer}>
            <TouchableOpacity
              style={{width: '100%', height: '100%'}}
              onPress={() => navigation.navigate('Chef_Settings_ContactUs')}>
              <View style={styles.item}>
          ...
          <View style={styles.itemContainer}>
            <TouchableOpacity
              style={{width: '100%', height: '100%'}}
              onPress={() => navigation.navigate('Chef_Settings_About')}>
              <View style={styles.item}>
                <View style={[styles.LeftIconContainer, {marginLeft: 5}]}>
                  <About />
