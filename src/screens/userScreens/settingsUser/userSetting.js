      ...
      <SafeAreaView style={{flex: 1}}>
        <ScrollView style={{flex: 1, backgroundColor: '#fFF'}}>
          <View style={{flex: 1, paddingTop: 30}}>
            <Pressable
              onPress={() => {
                navigation.navigate('User_Settings_Profile');
              }}>
              <View
                style={[
                ...
                <View style={[styles.containerName]}>
                  ...
                  <Text style={styles.lblUserID}>User ID</Text>
                </View>
                <View
                  style={{
                    flex: 1,
            ...
            <View style={styles.itemContainer}>
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.navigate('User_Settings_Notifications')
                }>
            ...
            <View style={styles.itemContainer}>
              <TouchableOpacity
                style={{width: '100%', height: '100%'}}
                onPress={() => navigation.navigate('User_Settings_Help')}>
                <View style={styles.item}>
                  <View style={styles.LeftIconContainer}>
                    <Help />
